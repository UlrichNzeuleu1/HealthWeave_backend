...
public interface AdresseApi {
    ...
    @GetMapping(value = APP_ROOT + "/adresses/{street}/getByStreet", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<List<AdresseDto>> findByStreet(@PathVariable String street);
